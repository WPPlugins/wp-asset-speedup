...
Hello, thanks for checking out WP Asset SpeedUp by Velocious.io - you are awesome!
...
By using WP Asset SpeedUp you are able to:
...
1. Upload the plugin files to the `/wp-content/plugins/wp-asset-speedup` directory, or install the plugin through the WordPress plugins screen directly.
2. Activate the plugin through the 'Plugins' screen in WordPress
3. Use the Velocious Name screen to configure the plugin

== Frequently Asked Questions ==

You can find Frequently Asked Questions [here](https://www.velocious.io/plugins/wp-asset-speedup/faq/ "WP Asset SpeedUp FAQs").